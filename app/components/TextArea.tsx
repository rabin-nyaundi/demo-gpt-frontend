  ...
  return (
    <div className="w-full relative h-auto flex items-end gap-2">
      <textarea
        ...
        disabled={isLoading}
        className="flex-1 resize-none rounded-md border border-gray-300 bg-gray-200 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400 text-sm disabled:opacity-50"
      />
      <button
        onClick={sendMessage}
        disabled={isLoading}
